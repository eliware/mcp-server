 ...
 * @param {Object} [options.log] - Logger instance (default: @eliware/log)
...
export async function mcpServer({
  ...
  try {
    ...
    name = name || packageJson.name || '@eliware/mcp-server';
  ...
  app.post('/', async (req, res) => {
    try {
      if (req && req.body && typeof req.body === 'object' && req.body.params) {
        if (!req.body.params._meta || typeof req.body.params._meta !== 'object') {
