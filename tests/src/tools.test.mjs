...
test('builds server and loads mjs tools', async()=>{const server=await buildServer({toolsDir:path(import.meta,'..','..','tools'),log,name:'test',version:'1',context:{}}); expect(server.options.name).toBe('test')});
